...
public class ProtoRESTBackend implements BackendService.Iface {
    private static final Logger LOG = Logger.getLogger(ProtoRESTBackend.class);
...
//      client.registerBackend(APP_ID, "localhost:" + listenPort);
    ...
    public static void main(String[] args) throws IOException, TException {
        ...
        ProtoRESTBackend protoBackend = new ProtoRESTBackend();
