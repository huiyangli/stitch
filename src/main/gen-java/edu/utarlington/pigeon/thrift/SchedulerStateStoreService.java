...
public class SchedulerStateStoreService {
  ...
  public interface Iface {
    ...
    public void updateNodeState(Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void updateNodeState(Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_updateNodeState(Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class updateNodeState_call extends org.apache.thrift.async.TAsyncMethodCall {
      private Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot;
      public updateNodeState_call(Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class updateNodeState_args implements org.apache.thrift.TBase<updateNodeState_args, updateNodeState_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateNodeState_args>   {
    ...
    public Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot; // required
    ...
    public updateNodeState_args(
      Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot)
    {
      this();
      this.snapshot = snapshot;
    }
    ...
    public updateNodeState_args(updateNodeState_args other) {
      if (other.isSetSnapshot()) {
        Map<String,edu.utarlington.pigeon.thrift.TNodeState> __this__snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(other.snapshot.size());
        for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> other_element : other.snapshot.entrySet()) {
    ...
    public void putToSnapshot(String key, edu.utarlington.pigeon.thrift.TNodeState val) {
      if (this.snapshot == null) {
        this.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>();
      }
      this.snapshot.put(key, val);
    }

    public Map<String,edu.utarlington.pigeon.thrift.TNodeState> getSnapshot() {
      return this.snapshot;
    }

    public updateNodeState_args setSnapshot(Map<String,edu.utarlington.pigeon.thrift.TNodeState> snapshot) {
      this.snapshot = snapshot;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SNAPSHOT:
        if (value == null) {
          ...
          setSnapshot((Map<String,edu.utarlington.pigeon.thrift.TNodeState>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map0.size);
                  String _key1;
                  edu.utarlington.pigeon.thrift.TNodeState _val2;
                  for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                  {
                    _key1 = iprot.readString();
                    _val2 = new edu.utarlington.pigeon.thrift.TNodeState();
                    _val2.read(iprot);
                    struct.snapshot.put(_key1, _val2);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.snapshot != null) {
          oprot.writeFieldBegin(SNAPSHOT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter4 : struct.snapshot.entrySet())
            {
        ...
        if (struct.isSetSnapshot()) {
          {
            ...
            for (Map.Entry<String, edu.utarlington.pigeon.thrift.TNodeState> _iter5 : struct.snapshot.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.snapshot = new HashMap<String,edu.utarlington.pigeon.thrift.TNodeState>(2*_map6.size);
            String _key7;
            edu.utarlington.pigeon.thrift.TNodeState _val8;
            for (int _i9 = 0; _i9 < _map6.size; ++_i9)
            {
              _key7 = iprot.readString();
              _val8 = new edu.utarlington.pigeon.thrift.TNodeState();
              _val8.read(iprot);
              struct.snapshot.put(_key7, _val8);
            }
          }
          struct.setSnapshotIsSet(true);
        }
